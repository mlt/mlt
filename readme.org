...
#+HTML: <picure><img src="https://vbr.nathanchung.dev/badge?page_id=mlt-mlt&color=00cf00" alt="Visitor counter"></picture>
* 👋Hello, my name is Mikhail (Mike) Titov

** 🚀About Me
Thank you for visiting my GitHub profile. I enjoy solving problems,
coding, automating tasks, fixing stuff, and contributing to
open-source projects. I like to explore new territories that is why
over the years I tapped into diverse areas stretching over low-level
machine instructions coding on Z80, numerical methods in mathematical
physics, OpenGL, computer networking, applied cryptography, privacy &
cybersecurity, COM & CORBA, GIS, and databases. I believe that wide
spectrum of my experiences can add value to any team.
...
- Collaboration and knowledge-sharing are essential for a thriving
  environment and stronger teams.
- Clean, readable, secure, and maintainable code is just as important
  as functionality.
- Strong work ethics.
...
** 🙃Misc
- @@html:<del>@@[[https://docs.google.com/document/d/1_ec1P9k4Jz_vuMD3q8ei-B9xmh647t7xQuQknl6MTks/edit?usp=sharing][In-car WiFi network troubleshooting]] with a network
  packet analyzer or how to *not* configure computer network, fail QA
  while passing QC, and infuriate customers.@@html:</del>@@ The issue
  was finally resolved with software version 329 as a part of the
  Service Campaign SW329 update in July, 2025.

#+HTML: <picure><img src="./github-metrics.svg" alt="GH metrics"></picture>
